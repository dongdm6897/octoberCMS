...
class InstallerTest extends TestCase
{
    ...
    public function dataForTestSupport()
    {
        return array(
            ...
            array('annotatecms-components', true),
            array('annotatecms-service', true),
            array('attogram-module', true),
            array('bitrix-module', true),
            array('bitrix-components', true),
    ...
    public function dataForTestInstallPath()
    {
        return array(
            ...
            array('annotatecms-components', 'addons/components/my_component/', 'vysinsky/my_component'),
            ...
            array('bitrix-components', 'bitrix/components/my_component/', 'author/my_component'),
            ...
            array('bitrix-d7-components', 'bitrix/components/author/my_component/', 'author/my_component'),
            ...
            array('eliasis-components', 'components/my_component/', 'shama/my_component'),
            ...
            array('fuelphp-components', 'components/demo/', 'fuelphp/demo'),
