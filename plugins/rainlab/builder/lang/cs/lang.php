...
return [
    ...
    'components' => [
        ...
        'list_no_records_description' => 'Message to display in the list in case if there are no records. Used in the default components\'s partial.',
        ...
        'list_display_column_description' => 'Column to display in the list. Used in the default components\'s partial.',
        ...
        'details_display_column_description' => 'Model column to display on the details page. Used in the default components\'s partial.',
        'details_display_column_required' => 'Please select a display column.',
        'details_not_found_message' => 'Not found message',
        'details_not_found_message_description' => 'Message to display if the record is not found. Used in the default components\'s partial.',
